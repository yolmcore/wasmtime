...
fn test_x64_emit() {
    ...
    // VPMULUDQ zmm0, zmm1, zmm2 (no mask, merging mode)
    ...
    // VPMULDQ zmm0, zmm1, zmm2 (no mask, merging mode)
    ...
    // VPROLD zmm0, zmm2, 7 (no mask, zeroing mode)
    ...
    // VPROLQ zmm0, zmm2, 13 (no mask, zeroing mode)
    ...
    // VPRORD zmm0, zmm2, 5 (no mask, zeroing mode)
    ...
    // VPRORQ zmm0, zmm2, 17 (no mask, zeroing mode)
